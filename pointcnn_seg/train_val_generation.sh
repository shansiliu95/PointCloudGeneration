...
gpu=
setting=
models_folder="../../models/generation/"
train_files="../../data/shapenet_partseg/train_val_files.txt"
val_files="../../data/shapenet_partseg/test_files.txt"

usage() { echo "train/val pointcnn_generation with -g gpu_id -x setting options"; }
...
CUDA_VISIBLE_DEVICES=$gpu python ../train_val_generation.py -t $train_files -v $val_files -s $models_folder -m pointcnn_seg -x $setting 
